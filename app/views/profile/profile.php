        ...
        <md-filled-tonal-icon-button href="/admin">
            <md-icon>Admin_Panel_Settings</md-icon>
                ...
                <div class="two-container">
                    <md-outlined-text-field prefix-text="🔒" aria-label="Password" class="passwordInput" type="password"
                        name="password" autocomplete="new-password" label="Mật khẩu" placeholder="Nhập mật khẩu của bạn">
                    ...
                    <md-outlined-text-field prefix-text="🔐" aria-label="Re-Password" name='repassword' type="password"
                        autocomplete="off" label="Nhập lại mật khẩu" placeholder="Nhập lại mật khẩu của bạn">
